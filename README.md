...
Kontent-cli support only running javascript migration files so in case you want to write in typescript or in any other language you have to transiple your code before running.
