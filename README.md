...
Kontent-CLI support only running javascript migration files so in case you want to write in TypesSript or in any other language you have to transpile your code before running.
